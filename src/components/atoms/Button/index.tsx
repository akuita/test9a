...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>((props: ButtonProps, ref) => {
  ...
  return ( // Use t function to translate button text
    <button ref={ref} className={clsx(className, styles.button, styles[buttonType], { [styles.rounded]: buttonType === 'primary' })} {...rest}>
      {t(component)}
    </button>
  )
})
